...
enum class Gender    // Ограничение по полу для купе
{
    MALE,
    FEMALE,
    NOT_SPECIFIED
...
enum class Place    // Перечисление свободно/занято место
{ 
    FREE,
    NOT_FREE
};

struct Compartment  // Структура хранения информации о купе
{ 
    Gender gender;
