...
/*
 * —труктура StopData - передача данных остановки из функции парсинга команды добавлени€ остановки
 * в методы добавлени€ остановки в справочник и другие функции, использующие данные парсинга
 */
struct StopData {
	Coordinates coordinates{ 0.0, 0.0 };					// √еографические координаты остановки
	std::unordered_map<std::string, int> nearby_stops{};	// –ассто€ни€ до соседних остановок
};
